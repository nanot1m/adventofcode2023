...
function testParser() {
	...
	deepStrictEqual(vecParser.parse("1,2"), V.vec(1, 2), "Expected `vec` parser to parse a vector")
	...
	deepStrictEqual(arrParser.parse("1,2"), [1, 2], "Expected `arr` parser to parse an array")
	...
	deepStrictEqual(
		arrTplParser.parse("hello world at position 1,2\nhello sun at position 3,4"),
		[
			{ name: "world", pos: V.vec(1, 2) },
